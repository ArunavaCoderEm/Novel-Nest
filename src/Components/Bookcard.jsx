  ...
  return (
    ...
    <div className="min-w-sm max-w-lg w-[350px] my-2 bg-white border mx-5 try border-gray-200 rounded-lg shadow dark:bg-amber-800 dark:border-amber-700">
        ...
        <div className="p-5">
            ...
            <Link to="/" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-slate-800 hover:text-white bg-amber-700 rounded-lg hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-amber-300 dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-amber-800">
                Read Book
